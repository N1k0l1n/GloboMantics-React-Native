...
const Video = ({navigation})=>{
    ...
    const getVids = async () => {
        try {
            const response = await fetch('https://www.googleapis.com/youtube/v3/search?part=snippet&q=pluralsight&type=video&key=AIzaSyBwI626sNhg3NskVbT4M9epCNfeMJGIBkY+');    
