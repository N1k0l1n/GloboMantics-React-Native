...
To keep the structure, extract the styles from the main file and place it in a {namefile.styles.js} do the same for the set of tests needed for each screen with the file {namefile.test.js}![Capture](https://user-images.githubusercontent.com/97979235/228053358-70baaa07-48f9-48de-bf21-476f399615b6.JPG)
